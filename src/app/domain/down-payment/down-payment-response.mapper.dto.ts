...
export class DownPaymentResponseMapper {
    ...
    public static fromDTO(data: Partial<DownPaymentDTO | DownPaymentDTO[]>,): DownPaymentDTO | DownPaymentDTO[] {
    ...
    public static fromEntity(entities: Partial<DownPayment | DownPayment[]>,): DownPaymentDTO | DownPaymentDTO[] {
