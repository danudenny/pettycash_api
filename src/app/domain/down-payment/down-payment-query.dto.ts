...
export class QueryDownPaymentDTO extends BasePayload {
  ...
  @ApiPropertyOptional({ description: 'Department ID', example: 'eaaf465b-65bc-4784-909e-8d0180c6eb4c', })
  departmentId: string;

  @ApiPropertyOptional({ description: 'State Down Payment', example: DownPaymentState.DRAFT, enum: DownPaymentState, })
  state: DownPaymentState;

  @ApiPropertyOptional({ description: 'Down Payment Type', example: DownPaymentType.REIMBURSEMENT, enum: DownPaymentType, })
  type: DownPaymentType;

  @ApiPropertyOptional({ description: 'Payment Type', example: DownPaymentPayType.CASH, enum: DownPaymentPayType, })
